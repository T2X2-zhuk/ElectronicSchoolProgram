...
@Component
public
class FieldForTransferOfStudentToANewClassValidator {

    @Autowired
    private List<FieldForTransferOfStudentToANewClassValidation> fieldForRegistrationStudentValidations;
    ...
    private List<ValidationErrorDTO> collectSingleStudentErrors(TransferOfStudentToANewClassRequest request) {
