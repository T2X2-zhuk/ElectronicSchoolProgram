package SchoolStudent.core.validations.specificCodeForRegistration;
...
@Component
public class SpecificCodeForRegistrationValidation extends RequestFieldsValidationImpl {
