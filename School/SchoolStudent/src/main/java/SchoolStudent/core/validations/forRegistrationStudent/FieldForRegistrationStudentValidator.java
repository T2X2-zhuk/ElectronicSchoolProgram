...
@Component
public
class FieldForRegistrationStudentValidator {

    @Autowired
    private List<FieldForRegistrationStudentValidation> fieldForRegistrationStudentValidations;
    ...
    private List<ValidationErrorDTO> collectSingleStudentErrors(RegistrationStudentInDatabaseRequest request) {
