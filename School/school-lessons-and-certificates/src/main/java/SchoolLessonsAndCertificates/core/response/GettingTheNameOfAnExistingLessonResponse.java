...
public class GettingTheNameOfAnExistingLessonResponse extends CoreResponse {

    private String lessonName;

    public GettingTheNameOfAnExistingLessonResponse(List<ValidationErrorDTO> errors) {
        super(errors);
    }
}
