...
class UpdateStudentInDatabaseTest extends UpdateStudentInDatabaseTestCase {
    ...
    private static final String TEST_FILE_BASE_FOLDER = "forUpdateStudent";

    @Test
    @DisplayName("ERROR_CODE_1_all_is_empty")
    public void check_ERROR_CODE_1() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_1_all_is_empty");
    }

    @Test
    @DisplayName("ERROR_CODE_2_not_such_student_with_so_email")
    ...
    @Test
    @DisplayName("ERROR_CODE_3_class_number_must_be_1-11")
    ...
    @Test
    @DisplayName("ERROR_CODE_4_successful")
    public void check_ERROR_CODE_4() throws Exception {
        executeAndCompare(TEST_FILE_BASE_FOLDER + "/ERROR_CODE_4_successful");
    }
}
